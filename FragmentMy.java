...
//                super.destroyItem(container, position, object);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lv = (ListView) view.findViewById(R.id.fragment03_lv);
...
//
//        View view = lif.inflate(R.layout.viewpager_, lv, false);

        //View headerView = LayoutInflater.from(getActivity()).inflate(R.layout.listview_header,null);

        View view = View.inflate(getActivity(),R.layout.viewpager,null);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                if (getItemViewType(position) == 0) {//有图片
                    ...
                    convertView = View.inflate(getActivity(), R.layout.fragment3_lv_item1, null);

                    one.ont_iv = (ImageView) convertView.findViewById(R.id.fragment03_iv);

                    one.one_tv_title = (TextView) convertView.findViewById(R.id.fragment03_title);
                    one.one_tv_subtitle = (TextView) convertView.findViewById(R.id.fragment03_subtitle);
                    ...
                    convertView = View.inflate(getActivity(), R.layout.fragment3_lv_item2, null);

                    two.two_tv_title = (TextView) convertView.findViewById(R.id.fragment03_title02);
                    two.two_tv_subtitle = (TextView) convertView.findViewById(R.id.fragment03_subtitle02);
